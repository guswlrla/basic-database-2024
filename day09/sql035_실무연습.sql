...
-- 단일행 함수, 변환 함수
/* sample. 60번 IT부서에 사원 급여를 12.3% 인상하기로 함.정수만 반올림하여
...
/* 8. 이름, 급여, 수당 여부에 따른 연봉을 포함하여 출력.
      Salary + Commission / Salary Only, 연봉이 높은순 (107개 행) */
...
-- JOIN
/* 11. Employee, Department 조인, 사원수가 5명 이상인 부서의 부서명, 사원수를 출력하시오.
       사원수를 내림차순으로 정렬 */
/* 12번 문제도 풀 수 있음 */
...
-- 서브쿼리
/* 12. 사원의 급여 정보 중 업무별 최소 급여를 받는 사원의
       이름, 업무, 급여, 입사일을 출력하시오. (21개 행) */
...
-- CASE 연산자(프로그래밍적인)
/* 13. 107명의 직원중 HR_REP(10%), MK_REP(12%), PR_REP(15%), SA_REP(18%), IT_PROG(20%) */
SELECT EMPLOYEE_ID
     , FIRST_NAME + ' ' + LAST_NAME AS 'name'
     , JOB_ID
     , SALARY
...
/* 14. 부서와 업무별 급여합계를 구하여 신년 급여수준레벨을 지정하고자 함
       부서번호, 업무를 기준으로 그룹별로 나누고 급여합계와 인원수를 출력하시오. (20개 행) */
